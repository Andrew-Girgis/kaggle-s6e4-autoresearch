...
The dataset for this competition (both train and test) was generated from a deep learning model trained on the [Irrigation Prediction dataset](https://www.kaggle.com/datasets/miadul/irrigation-water-requirement-prediction-dataset/data). Feature distributions are close to, but not exactly the same, as the original. Feel free to use the original dataset as part of this competition, both to explore differences as well as to see whether incorporating the original in training improves model performance.
## Files
...
- [Multi‑Model Blending-Pseudo‑label 0.99 threshold ](https://www.kaggle.com/code/mohamedbentalb/multi-model-blending-pseudo-label-0-99-threshold) - Mohamed Bentalb (votes: 8, views: 55)
- [Predicting Irrigation Need: LightGBM](https://www.kaggle.com/code/conradkleykamp/predicting-irrigation-need-lightgbm) - Conrad Kleykamp (votes: 29, views: 245)
- [highest score 0.98151 public LB](https://www.kaggle.com/code/mohamedsadokaissaoui/highest-score-0-98151-public-lb) - Mohamed Sadok Aissaoui (votes: 33, views: 295)
- [Predicting Irrigation Need](https://www.kaggle.com/code/ldausl/predicting-irrigation-need) - Muhammad Firdaus (votes: 33, views: 661)
- [Predicting Irrigation Need PROJECT (MODEL)](https://www.kaggle.com/code/tevoshw/predicting-irrigation-need-project-model) - tevoshw (votes: 2, views: 44)
- [🫩Bulk Submission Scraper / Public LB Overfit](https://www.kaggle.com/code/andreipaulavets/bulk-submission-scraper-public-lb-overfit) - Andrei Paulavets (votes: 6, views: 35)
- [pgs-s6e4-lgbm-optuna](https://www.kaggle.com/code/shivamgravity/pgs-s6e4-lgbm-optuna) - Shivam (votes: 9, views: 64)
- [PS-s6e4 | Ensemble of solutions (11)](https://www.kaggle.com/code/nina2025/ps-s6e4-ensemble-of-solutions-11) - F.A.Nina (votes: 44, views: 356)
- [S6E4: Predicting Irrigation Need](https://www.kaggle.com/code/parthsarnobat/s6e4-predicting-irrigation-need) - Parth Sarnobat (votes: 13, views: 109)
- [Predicting Irrigation Need](https://www.kaggle.com/code/maxaref/predicting-irrigation-need) - Max Arefev (votes: 2, views: 69)
- [LGBM_v5_argmax_FE_AB_0.96618](https://www.kaggle.com/code/iamzishankhan/lgbm-v5-argmax-fe-ab-0-96618) - zishan khan (votes: 4, views: 18)
- [Predict_irrigation_need_s6e04](https://www.kaggle.com/code/les1781/predict-irrigation-need-s6e04) - LeoStaz (votes: 0, views: 0)
- [5DifferentApproach98PlusScore](https://www.kaggle.com/code/adnan16/5differentapproach98plusscore) - Adnan Ashraf (votes: 1, views: 14)
- [Irrigation Need EDA](https://www.kaggle.com/code/kuusistotuomas/irrigation-need-eda) - Tuomas Kuusisto (votes: 1, views: 9)
- [Irrigation Need - PyTorch](https://www.kaggle.com/code/obiaf88/irrigation-need-pytorch) - De Marchi Fabio (votes: 0, views: 27)
- [Predicting_Irrigation_Need](https://www.kaggle.com/code/neclaersz/predicting-irrigation-need) - Necla ERSÖZ (votes: 0, views: 15)
- [Predicting_Irrigation_Need](https://www.kaggle.com/code/aslihanakg/predicting-irrigation-need) - Aslıhan Akgöğ (votes: 0, views: 0)
- [Stacked CatBoost + LGBM + XGB 0.97450](https://www.kaggle.com/code/tudorbeloiu/stacked-catboost-lgbm-xgb-0-97450) - Tudor Beloiu (votes: 22, views: 316)
- [BEST LB 0.98148](https://www.kaggle.com/code/mohamedsadokaissaoui/best-lb-0-98148) - Mohamed Sadok Aissaoui (votes: 23, views: 223)
- [S6E4 | Highest Score XGBoost CV:0.98109](https://www.kaggle.com/code/rawashishsin/s6e4-highest-score-xgboost-cv-0-98109) - AshishSinghRawat (votes: 43, views: 417)
...
#### 2. SUBMISSION LIMITS
a. You may submit a maximum of ten (10) Submissions per day.
...
The Competition Data is also subject to the following terms and conditions: [Attribution 4.0 International (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/).
b. Data Security.
...
4. not a person or representative of an entity under U.S. export controls or sanctions (see: [https://www.treasury.gov/resourcecenter/sanctions/Programs/Pages/Programs.aspx][1]).
